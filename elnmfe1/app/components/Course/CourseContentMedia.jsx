...
import AskQuestion from "@/app/components/Course/AskQuestion"
...
const CourseContentMedia = ({
  ...
  // const [questionAI, setQuestionAI] = useState<string>('');
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto pb-10">
      {/*show video*/}
      <CoursePlayer
      ...
      <div className="w-full flex items-center justify-between my-3">
        <div
          className={`${
            styles.button
          } text-white  !w-[unset] !min-h-[40px] !py-[unset] ${activeVideo ===
            0 && "!cursor-no-drop opacity-[.8]"}`}
          onClick={() =>
        ...
        <div
          className={`${
            styles.button
          } !w-[unset] text-white  !min-h-[40px] !py-[unset] ${data?.length -
            1 ===
            activeVideo && "!cursor-no-drop opacity-[.8]"}`}
          onClick={() =>
            setActiveVideo(
      ...
      <div className="w-full p-4 flex items-center justify-between bg-slate-500 bg-opacity-20 backdrop-blur shadow-[bg-slate-700] rounded shadow-inner res-over-x">
        {["Overview", "Resources", "Ask Teacher", "Reviews", "Ask AI"].map(
          (text, index) => (
            <h5
              key={index}
              className={`whitespace-nowrap 800px:text-[20px] cursor-pointer ${
                activeBar === index
                  ? "text-red-500"
        ...
        <>
          ...
          <div className="w-full flex justify-end">
            <div
              className={`${
                styles.button
              } !w-[120px] !h-[40px] text-[18px] mt-5 ${questionCreationLoading &&
                "cursor-not-allowed"}`}
              ...
              <>
                ...
                <div className="w-full flex justify-end">
                  <div
                    className={`${
                      styles.button
                    } !w-[120px] !h-[40px] text-[18px] mt-5 800px:mr-0 mr-2 ${reviewCreationLoading &&
                      "cursor-no-drop"}`}
                    onClick={
      ...
      {activeBar === 4 && (
        ...
        //         cols={40}
        //         rows={5}
        //         placeholder="Write your question with AI..."
        //         className="outline-none bg-transparent ml-3 border dark:text-white text-black border-[#0000001d] dark:border-[#ffffff57] 800px:w-full p-2 rounded w-[90%] 800px:text-[18px] font-Poppins"
        //     ></textarea>
        //
        //   </div>
        ...
        //         }`}
        //         onClick={questionCreationLoading ? () => {} : handleQuestionAI}
        //     >
        //       Submit
        //     </div>
        //   </div>
                ...
                <div className="pl-3">
                  <div className="flex items-center">
                    <h5 className="text-[20px]">
                      {item.user.name} {item.user.role === "admin" && "- Admin"}
                      {item.user.role === "teacher" && "- Teacher"}
                    </h5>{" "}
